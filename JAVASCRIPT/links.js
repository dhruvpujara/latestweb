const animes = [
  { 
    ...
    "status": "Completed",
    "description": "Naruto Shippuden continues the story of Naruto Uzumaki in his teenage years as he and his allies protect their world against an evil organization known as the Akatsuki. Set two and a half years after the original series, the show follows Naruto's quest to rescue his friend Sasuke while defending their world from increasingly dangerous threats.",
    "9ANIME": "https://9anime.to/watch/naruto-shippuden.00zr"
  },
  ...
  { 
    ...
    "episodes": "153",
    "genre": "Adventure, Fantasy, Martial Arts, Shounen, Super Power",
    "status": "Completed",
    "description": "Follows the adventures of Son Goku from childhood to adulthood as he trains in martial arts and explores the world in search of the seven mystical orbs known as the Dragon Balls, which can summon a wish-granting dragon when gathered.",
    "9ANIME": "https://9anime.to/watch/dragon-ball.4y6z"
  },
  ...
  { 
    ...
    "status": "Ongoing",
    "description": "Follows the adventures of Monkey D. Luffy and his pirate crew in hopes of finding the greatest treasure ever left by the legendary Pirate, Gold Roger. The famous mystery treasure named One Piece.",
